          ...
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              <motion.div
                ...
                className="absolute -top-12 sm:-top-16 left-1/2 z-50 flex -translate-x-1/2 flex-col items-center justify-center rounded-md bg-black px-2 sm:px-4 py-1 sm:py-2 text-xs shadow-xl"
              >
                ...
                <div className="text-[10px] sm:text-xs text-white">{item.designation}</div>
              </motion.div>
            )}
          </AnimatePresence>
          <img
